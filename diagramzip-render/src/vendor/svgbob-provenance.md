...
```sh
docker run --rm -v "$PWD/diagramzip-render/svgbob-wasm:/build" -w /build \
  rust@sha256:948f9b08a66e7fe01b03a98ef1c7568292e07ec2e4fe90d88c07bb14563c84ff \
...
The checked-in `svgbob_wasm_bg.js` and `svgbob_wasm_bg.wasm` files are copied
