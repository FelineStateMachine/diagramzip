...
const jsrunnerOverlay = resolve(root, 'd2-wasm/overlays/jsrunner')
...
const staging = resolve(root, 'd2-wasm/.d2-build')
...
execFileSync('go', ['mod', 'edit', `-modfile=${stagedModfile}`, `-replace=oss.terrastruct.com/d2=${stagedModule}`], { cwd: source })
