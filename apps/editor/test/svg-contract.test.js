...
test('normalizes TRN table structure and relationship zones', () => {
  const trn = canonicalizeSvg(
    ...
    metadata, 'trn', 'diagramzip-trn@16',
  )
...
test('normalizes CSS-driven Mermaid and BPMN neutral structures', () => {
  ...
  assert.match(sequence, /class="actor actor-top"[^>]*data-dz-fill="surface-1"[^>]*data-dz-stroke="line"/)
  assert.match(sequence, /class="actor-line"[^>]*data-dz-stroke="line-muted"/)
  assert.match(sequence, /class="messageLine0"[^>]*data-dz-stroke="line"/)
  assert.match(sequence, /class="labelBox"[^>]*data-dz-fill="surface-1"[^>]*data-dz-stroke="line"/)
