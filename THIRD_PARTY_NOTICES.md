...
| `renderers/client/bpmn/` | bpmn-js 18.25.1 | Custom bpmn.io MIT-like terms, including its watermark condition; browser bundle is delivered to recipients | [bpmn.io terms](licenses/bpmn-license.txt) |
