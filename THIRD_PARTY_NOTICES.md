...
| --- | --- | --- | --- |
| `renderers/browser-run/frames/mermaid/` | Mermaid 11.17.0 and its emitted browser dependencies | Mermaid is MIT; browser bundle is delivered to recipients | [Mermaid text](licenses/mermaid-license.txt), package lock |
| Excalidraw Worker | Excalidraw 0.18.1, RoughJS, linkedom, and emitted runtime dependencies | Excalidraw and its runtime dependencies retain their upstream permissive licenses inside the emitted Worker | [Excalidraw text](licenses/excalidraw-license.txt), [generated npm runtime notice](renderers/edge/artifacts/licenses/npm-runtime-NOTICE.md) |
| `renderers/browser-run/frames/diagramsnet/` | diagrams.net 29.6.1 export runtime, shapes, stencils, images, and math assets | Application code is Apache-2.0; visual assets retain the additional diagrams.net terms. The built Browser Run frame publishes both beside the bundle | [renderer notice](renderers/browser-run/frames/diagramsnet/README.md), nested `vendor/assets/*/LICENSE` files |
| TikZ edge Worker and `renderers/edge/artifacts/tikz/` | `@planktimerr/tikzjax` 1.0.63 plus TeX/TikZ assets | The Worker adapter and derived TikZJax core are GPL-3.0-or-later; bundled TeX/TikZ material is LPPL-1.3c. Corresponding source, provenance, and terms are kept with the artifact | [artifact provenance](renderers/edge/artifacts/tikz/provenance.md), `renderers/edge/artifacts/tikz/licenses/` |
