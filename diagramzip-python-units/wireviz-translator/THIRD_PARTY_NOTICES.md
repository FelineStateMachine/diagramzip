...
Pristine source from the `yuzutech/WireViz` v0.3.3 release tag (`837d5425e72aa002bbe9cc60604dfeffab86d29c`) is vendored under `src/wireviz/` and is licensed under GPL-3.0. See `vendor-licenses/WireViz-LICENSE`.
