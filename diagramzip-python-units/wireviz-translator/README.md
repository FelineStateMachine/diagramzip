...
This unit vendors the pristine `yuzutech/WireViz` v0.3.3 release tag (commit `837d5425e72aa002bbe9cc60604dfeffab86d29c`), whose own runtime version remains 0.3.2, and stops after its upstream parser/model has produced GraphViz DOT. The DOT is sent through the `GRAPHVIZ` service binding to the shared GraphViz-Wasm Worker.
...
The request parser caps bodies at 1 MiB, sources at 512 KiB, YAML nesting and
expanded nodes, component counts, pin/wire lists, connection sets, and numeric
