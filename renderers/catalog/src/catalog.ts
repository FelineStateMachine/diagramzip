import { ENGINE_IDS, type EngineId, type EngineRuntime } from '../../shared/engines'
import { normalizationFor, type NormalizationCapability } from '../../../shared/svg/index.js'
...
export interface EngineCatalogEntry {
  ...
  normalization: NormalizationCapability
}
...
const targetRuntime: Record<EngineId, EngineRuntime> = {
  ...
  bytefield: 'edge-js',
  dbml: 'edge-wasm',
  diagramsnet: 'browser-run',
  ditaa: 'edge-wasm',
  erd: 'edge-wasm',
  excalidraw: 'browser-run',
  goat: 'edge-wasm',
  nomnoml: 'edge-js',
  pikchr: 'edge-wasm',
  structurizr: 'edge-js',
