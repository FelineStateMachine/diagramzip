...
if (catalog.format !== 'svg' || !Array.isArray(catalog.engines) || catalog.engines.length !== 30) {
  throw new Error('The catalog response does not contain all 30 SVG engines.')
}
...
console.log('The catalog service is healthy. It lists 30 engines and has no render proxy.')
