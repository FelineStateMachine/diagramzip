...
import plantumlViz from '../../artifacts/plantuml-family/viz-global.cjs'
import vizModule from '../../artifacts/plantuml-family/viz.wasm'
// @ts-expect-error The pinned TeaVM browser artifact is vendored JavaScript.
import { renderToString } from '../../artifacts/plantuml-family/plantuml.js'
