import bpmn from '../examples/bpmn.bpmn?raw'
import bytefield from '../examples/bytefield.bf?raw'
import d2 from '../examples/d2.d2?raw'
import dbml from '../examples/dbml.dbml?raw'
import diagramsnet from '../examples/diagramsnet.drawio?raw'
import erd from '../examples/erd.erd?raw'
import excalidraw from '../examples/excalidraw.excalidraw?raw'
import goat from '../examples/goat.goat?raw'
import nomnoml from '../examples/nomnoml.nomnoml?raw'
import nwdiag from '../examples/nwdiag.diag?raw'
import packetdiag from '../examples/packetdiag.diag?raw'
import pikchr from '../examples/pikchr.pikchr?raw'
import rackdiag from '../examples/rackdiag.diag?raw'
import svgbob from '../examples/svgbob.bob?raw'
import symbolator from '../examples/symbolator.sv?raw'
import tikz from '../examples/tikz.tex?raw'
import umlet from '../examples/umlet.uxf?raw'
import vega from '../examples/vega.json?raw'
import vegalite from '../examples/vegalite.json?raw'
import wavedrom from '../examples/wavedrom.json5?raw'
import wireviz from '../examples/wireviz.yaml?raw'
